...
------------------------------------
	...
	modapiext.dialog:addRuledDialog("MoveEnd", { Unique = true, Odds = 10, Dialog(
		...
		CastRules = {
			...
			other = PersonalityRule("flynn_personality"),
			target = function(pawnId, cast)
				local p1 = Game:GetPawn(cast.other):GetSpace()
...
------------------------------------
	-- modapiext.dialog:addRuledDialog("Pilot_Story_Conversation", { Unique = true, Odds = 10, Dialog(
		...
		-- ),
		-- CastRules = {
			-- main = SelectedPersonalityRule("Metalocif"),
			-- other = PersonalityRule("Generic")
		-- }
	-- })
		
	-- Personality.Metalocif.Convo_Metalocif_Generic1 = { "Hey, Generic. Do you have the cyborg prototypes I asked you for?" }
	-- Personality.Generic.Convo_Metalocif_Generic2 = { "Testing is coming nicely, but I've been busy piloting as of late." }
	-- Personality.Metalocif.Convo_Metalocif_Generic3 = { "Can you do 6 more for me?" }
------------------------------------
end
